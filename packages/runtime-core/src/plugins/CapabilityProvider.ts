...
export interface EvaluationProvider extends CapabilityProvider {
  evaluatePlans(plans: ExecutionPlan[], goal: Goal, context: ExecutionContext, policy: import('../planning/EvaluationPolicy.js').EvaluationPolicy): Promise<import('../planning/PlanningSession.js').ScoredPlan[]>;
}
