        ...
        <div className="h-16 flex items-center px-6 border-b border-border/50">
          <div className="flex items-center gap-3 w-full cursor-pointer hover:opacity-80 transition-opacity">
            ...
            <div className="flex-1 overflow-hidden">
              <p className="text-sm font-semibold truncate text-white">Acme Corp Labs</p>
        ...
        <div className="p-4 border-t border-border/50">
          <button className="flex items-center gap-3 w-full p-2 rounded-md hover:bg-surface-hover transition-colors">
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-xs text-muted truncate">jane@acmecorp.com</p>
            </div>
          </button>
        </div>
      </aside>
        ...
        <header className="h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8 bg-surface/50 backdrop-blur-md border-b border-border/50 sticky top-0 z-30">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center text-sm text-muted">
              ...
              <span className="text-white font-medium">Research Workspace</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <button className="p-2 text-gray-400 hover:text-white transition-colors relative">
              <Bell size={18} />
              <span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-red-500 border border-surface"></span>
            </button>
            
            <button className="hidden sm:flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors">
              <Plus size={16} />
              Upload Document
            </button>
          </div>
