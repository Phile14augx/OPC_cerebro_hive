...
export type SkillOut = { id: string; slug: string; name: string; description: string; version: string; author: string; installed: boolean };
export type TemplateOut = { slug: string; name: string; description: string; category: string };
