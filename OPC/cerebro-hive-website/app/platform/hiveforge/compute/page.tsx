...
const QUICK_ITEMS: { itemId: string; label: string; kind: string }[] = [
  { itemId: "shared-vps", label: "Shared VPS", kind: "vps" },
  { itemId: "enterprise-vps", label: "Enterprise VPS", kind: "vps" },
  { itemId: "nvidia-l4", label: "NVIDIA L4 GPU", kind: "gpu" },
  { itemId: "nvidia-h100", label: "NVIDIA H100 GPU", kind: "gpu" },
  { itemId: "managed-kubernetes", label: "Managed Kubernetes", kind: "kubernetes" },
  { itemId: "serverless-functions", label: "Serverless Functions", kind: "serverless" },
];
...
export default function ComputeConsolePage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 pb-24 pt-8">
      ...
      <p className="mt-3 max-w-2xl text-text-secondary">VPS, GPU, Kubernetes, containers, and serverless — the full compute portfolio, provisioned on demand.</p>
