...
export const cerebro_ai_enterprise: SoftwarePlatform = {
  type: "software",
  slug: "cerebro-ai-enterprise",
  name: "Cerebro AI Enterprise",
  tagline: "Enterprise AI Assistant",
  description: "CerebroHive's Cerebro AI Enterprise transforms operations by integrating AI directly into core enterprise workflows.",
  color: "#00F57A",
