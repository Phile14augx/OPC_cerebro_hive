...
**Goals:**
- [ ] Commit constitution only on `docs/w0-1-portfolio-baseline-v1` via `docs/portfolio/w0.1-land-constitution.sh` (not on the Twin Studio branch)
- [ ] Merge that branch to `main` so GitHub indexes `docs/portfolio/`
