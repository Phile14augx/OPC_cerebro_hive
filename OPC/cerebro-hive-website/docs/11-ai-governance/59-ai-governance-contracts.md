---
title: "AI Governance in Client Contracts"
part: "Part XI"
...
# AI Governance in Client Contracts

## Overview

Contract clauses that address AI governance: data use, model documentation, bias, and liability.
