---
title: "TDR -- Container Orchestration"
part: "Part X"
...
# TDR -- Container Orchestration

## Purpose

Technology Decision Record: Kubernetes vs. serverless vs. managed container services.
...
# Replace with actual implementation patterns for: TDR -- Container Orchestration
```
