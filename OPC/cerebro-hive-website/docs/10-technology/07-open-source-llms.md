---
title: "Open Source LLMs -- Usage Guide"
part: "Part X"
...
# Open Source LLMs -- Usage Guide

## Purpose

Llama 3.1, Mistral, Phi, and Qwen -- when to self-host, deployment options, and tradeoffs.
...
# Replace with actual implementation patterns for: Open Source LLMs -- Usage Guide
```
