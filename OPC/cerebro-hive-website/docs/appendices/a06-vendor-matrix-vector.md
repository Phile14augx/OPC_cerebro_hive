---
title: "Appendix C4 -- Vector Database Comparison Matrix"
part: "Appendices"
...
# Appendix C4 -- Vector Database Comparison Matrix

> **Note:** Reference document -- kept current by the CerebroHive Operations team. Last reviewed: [DATE]

## Overview

Comparison of vector databases: Pinecone, Weaviate, Chroma, Qdrant, pgvector, and Milvus.
