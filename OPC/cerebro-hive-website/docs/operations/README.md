...
| [runbooks/](./runbooks/) | Operational runbooks (AI cost budget breach, ArgoCD out of sync, DB connection exhaustion, high error rate, node memory pressure, pod crashloop, SLO burn rate, [day1-local-bootstrap.md](./runbooks/day1-local-bootstrap.md)) |
