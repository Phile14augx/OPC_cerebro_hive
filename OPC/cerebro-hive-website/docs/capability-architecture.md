...
| Tier | Layer | Products |
|---|---|---|
| 0 | Root | HiveIdentity, HiveShield |
| 1 | Infrastructure | HiveCompute, HiveStorage, HiveNetwork |
| 2 | Platform Services | HiveForge, HiveOps, HiveAPI, HiveConsole, HiveGateway |
| 3 | AI Runtime & Intelligence | HiveModels, HiveAgents, HiveAutomation, HivePlanner, HiveReasoner, HiveMemory, HiveEvaluation, HiveData, HiveLake, HiveAnalytics, HiveKnowledge, HiveSemantic, HiveVector, HiveObservatory |
