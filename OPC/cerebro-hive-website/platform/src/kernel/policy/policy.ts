...
const ROLE_GRANTS: Record<string, string[]> = {
  ...
  developer: [
    ...
    "cerebroinsight:read", "cerebroinsight:write",
  ],
  analyst: [
    ...
    "digitaltwin:read", "research:read", "zerotrust:read", "dataplatform:read", "hiveforge:read", "cerebrostudio:read", "cerebroswarm:read", "cerebroinsight:read",
  ],
