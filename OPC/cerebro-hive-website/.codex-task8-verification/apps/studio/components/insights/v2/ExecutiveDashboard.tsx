...
const readinessIndex = [
  ...
  { metric: "Data Readiness", score: 82, color: "bg-accent-primary" },
    ...
    <section className="py-12 border-b border-border bg-background">
      <div className="container-wide">
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 bg-surface border border-border rounded-2xl p-6 md:p-8 flex flex-col justify-center">
            <div className="text-[10px] uppercase tracking-widest text-accent-secondary font-bold mb-6 flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {dashboardStats.map((stat, i) => (
                <div key={i} className="flex flex-col gap-2">
                  ...
                  <div className="text-lg font-space font-bold text-text-primary leading-tight">{stat.value}</div>
          ...
          <div className="lg:col-span-4 bg-surface border border-border rounded-2xl p-6 md:p-8">
            <div className="text-[10px] uppercase tracking-widest text-accent-primary font-bold mb-6 flex items-center gap-2">
            ...
            <div className="space-y-4">
              {readinessIndex.map((item, i) => (
                <div key={i} className="flex items-center gap-4">
                  ...
                  <div className="w-6 text-right text-xs font-mono text-text-primary font-bold">{item.score}</div>
                </div>
              ))}
            </div>
