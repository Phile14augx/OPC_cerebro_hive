      ...
      <div className="container-wide">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {articles.map((article, i) => (
            <TrackedLink href="/research" key={i} analyticsEvent="featured_intelligence_click" analyticsCategory="insights" analyticsLabel={article.title} className="group bg-surface border border-border rounded-2xl p-8 hover:border-border-strong transition-all flex flex-col cursor-pointer relative overflow-hidden h-full">
