...
export const cerebro_analytics: SoftwarePlatform = {
  type: "software",
  slug: "cerebro-analytics",
  name: "Cerebro Analytics",
  tagline: "Executive Dashboards",
  description: "CerebroHive's Cerebro Analytics transforms operations by integrating AI directly into core enterprise workflows.",
  color: "#00F57A",
