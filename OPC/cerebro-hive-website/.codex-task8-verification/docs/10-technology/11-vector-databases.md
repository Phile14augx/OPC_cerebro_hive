...
Pinecone vs. Weaviate vs. pgvector vs. Qdrant -- selection matrix, cost model, and migration.
...
# Replace with actual implementation patterns for: Vector Database Selection Guide
```
