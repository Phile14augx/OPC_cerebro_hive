---
title: "TDR -- LLM Provider Selection"
part: "Part X"
...
# TDR -- LLM Provider Selection

## Purpose

Technology Decision Record: choosing between OpenAI, Anthropic, Google, and open source models.
...
# Replace with actual implementation patterns for: TDR -- LLM Provider Selection
```
