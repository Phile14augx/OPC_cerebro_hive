---
title: "AWS AI/ML Services Guide"
part: "Part X"
...
# AWS AI/ML Services Guide

## Purpose

SageMaker, Bedrock, Comprehend, Textract -- when to use managed services vs. custom models.
...
# Replace with actual implementation patterns for: AWS AI/ML Services Guide
```
