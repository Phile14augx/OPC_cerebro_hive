---
title: "GTM Quarterly Review Template"
part: "Part VI"
...
date: "July 2026"
status: "scaffold"
tags: [gtm, marketing, sales, demand-generation]
---

# GTM Quarterly Review Template

## Purpose

Template for quarterly GTM performance review: actuals vs. plan, learnings, and adjustments.
...
CerebroHive's sales process follows the MEDDPPICC qualification framework: Metrics (the measurable business outcomes the client is trying to achieve), Economic Buyer (the executive with budget authority and final decision power), Decision Criteria (the factors the client will use to select a provider), Decision Process (the steps, timeline, and stakeholders in the buying process), Paper Process (legal, procurement, and contracting requirements), Identified Pain (the specific problem driving urgency), Champion (the internal advocate who will navigate the organization on CerebroHive's behalf), and Competition (the other vendors or alternatives under consideration).
...
| --- | --- | --- | --- |
| GTM Quarterly Review Template primary KPI | [Target] | [Method] | Monthly |
| GTM Quarterly Review Template secondary KPI | [Target] | [Method] | Quarterly |
