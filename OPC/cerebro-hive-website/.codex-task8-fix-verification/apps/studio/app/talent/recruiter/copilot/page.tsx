    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white p-8 font-sans">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex justify-between items-end border-b border-[#222] pb-6">
          ...
          <TrackedButton eventCategory="recruiter-copilot" eventLabel="Adjust Target Profile" eventAction="adjust_target_profile_click" className="px-4 py-2 bg-[#222] hover:bg-[#333] border border-[#444] rounded text-sm transition-colors flex items-center gap-2">
            ...
            <div className="col-span-1 space-y-4">
              ...
              {candidates.map((c: any, index: number) => (
                <div
                  key={c.candidateId}
                  onClick={() => {
                    analytics.track({ eventName: 'click', category: 'recruiter-copilot', label: `Select candidate: ${c.candidateName || c.candidateId}` });
