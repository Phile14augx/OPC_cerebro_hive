    ...
    <div className="w-full animate-fade-in-up">
      ...
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between items-center">
            ...
            <TrackedLink href="/forgot-password" analyticsEvent="forgot_password_click" analyticsCategory="login" analyticsLabel="Forgot password?" className="text-sm text-indigo-400 hover:text-indigo-300 transition-colors focus:outline-none focus:underline rounded">
              Forgot password?
            </TrackedLink>
          </div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          <TrackedButton eventCategory="login" eventLabel="Google" className="flex justify-center items-center gap-2 py-2.5 px-4 rounded-lg bg-surface border border-border/50 hover:bg-surface-hover transition-colors text-gray-300 font-medium focus:outline-none focus:ring-2 focus:ring-brand">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12.545,10.239v3.821h5.445c-0.712,2.315-2.647,3.972-5.445,3.972c-3.332,0-6.033-2.701-6.033-6.032s2.701-6.032,6.033-6.032c1.498,0,2.866,0.549,3.921,1.453l2.814-2.814C17.503,2.988,15.139,2,12.545,2C7.021,2,2.543,6.477,2.543,12s4.478,10,10.002,10c8.396,0,10.249-7.85,9.426-11.761H12.545z" />
            </svg>
            Google
          </TrackedButton>
          <TrackedButton eventCategory="login" eventLabel="GitHub" className="flex justify-center items-center gap-2 py-2.5 px-4 rounded-lg bg-surface border border-border/50 hover:bg-surface-hover transition-colors text-gray-300 font-medium focus:outline-none focus:ring-2 focus:ring-brand relative overflow-hidden group">
