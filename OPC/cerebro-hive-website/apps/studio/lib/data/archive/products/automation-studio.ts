...
export const automation_studio: SoftwarePlatform = {
  type: "software",
  slug: "automation-studio",
  name: "Automation Studio",
  tagline: "Workflow and Process Automation",
  description: "CerebroHive's Automation Studio transforms operations by integrating AI directly into core enterprise workflows.",
  color: "#00F57A",
