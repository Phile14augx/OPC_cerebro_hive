...
export const knowledge_hub: SoftwarePlatform = {
  type: "software",
  slug: "knowledge-hub",
  name: "Knowledge Hub",
  tagline: "Enterprise Knowledge Management",
  description: "CerebroHive's Knowledge Hub transforms operations by integrating AI directly into core enterprise workflows.",
  color: "#00F57A",
