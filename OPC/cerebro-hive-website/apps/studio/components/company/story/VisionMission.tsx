...
import { 
  User, Target, Code, Rocket, TrendingUp, BookOpen, Quote,
  Globe2, Building2, BarChart3, Coins
} from "lucide-react";
...
const VisionIcon = getIcon(visionMission.vision.presentation.icon);
    ...
    <div className="absolute inset-0 opacity-[0.03]">
      <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <pattern id="network-mesh" x="0" y="0" width="120" height="120" patternUnits="userSpaceOnUse">
          <circle cx="60" cy="60" r="1.5" fill="currentColor" className="text-text-primary" />
          <path d="M 60 60 L 180 180 M 60 60 L -60 180 M 60 60 L 180 -60 M 60 60 L -60 -60" stroke="currentColor" className="text-text-primary" strokeWidth="0.5" />
        </pattern>
      ...
      <div className="container-wide relative z-10 flex flex-col gap-12 md:gap-24">
        ...
        <div id="company-purpose" className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-start pt-12">
          ...
          <motion.div variants={prefersReducedMotion ? {} : motionPresets.fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="lg:col-span-7 pr-0 lg:pr-12">
            <h2 className="text-4xl md:text-5xl lg:text-[64px] font-space font-bold text-text-primary tracking-tight leading-[1.05] mb-10">
            ...
            <div className="bg-surface-elevated border border-border p-8 rounded-2xl relative overflow-hidden">
              ...
              <p className="relative z-10 text-lg font-space italic text-text-primary leading-relaxed">
                &ldquo;Our goal is not merely to deploy AI models. It is to fundamentally transform how entire enterprise divisions operate, measure, and scale.&rdquo;
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={prefersReducedMotion ? {} : motionPresets.fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="lg:col-span-5 relative mt-12 lg:mt-0">
            <div className="bg-surface/80 border border-border rounded-3xl p-8 backdrop-blur-xl relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 flex flex-col gap-0">
                ...
                {visionMission.purpose.evidence.framework.map((node) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-4 py-4">
                        ...
                        <span className={cn("text-sm font-space font-bold uppercase tracking-wider transition-colors duration-300", isActive ? "text-text-primary" : "text-text-secondary group-hover:text-text-primary")}>
                          {node.label}
                        </span>
                      </div>
        ...
        {/* ==========================================
           ...
           ========================================== */}
        <motion.div 
          className="max-w-5xl mx-auto rounded-[32px] bg-[#040d1a]/60 border border-border p-12 lg:p-20 relative overflow-hidden group shadow-2xl backdrop-blur-md"
            ...
            <div className="lg:col-span-7">
              <div className="flex items-center gap-3 mb-10">
                <div className="w-12 h-12 rounded-2xl border border-blue-500/20 bg-blue-500/10 flex items-center justify-center">
                  <VisionIcon size={20} className="text-blue-400" aria-hidden="true" />
                </div>
                <span className="text-[10px] font-space font-bold uppercase tracking-[0.2em] text-blue-400">Our Vision</span>
              </div>
              
              <h3 className="text-4xl md:text-[56px] font-space font-bold text-text-primary leading-[1.15] mb-12">
                {visionMission.vision.content.headline}
              </h3>
              
              {/* Strategic Focus */}
              <div className="space-y-5">
                <span className="text-[10px] font-mono text-text-muted uppercase tracking-widest border-b border-border pb-2 block w-full max-w-xs">
                  Strategic Focus
                </span>
        ...
        <div className="max-w-[1400px] mx-auto w-full">
          <div className="text-center mb-20">
            ...
            <h3 className="text-4xl md:text-[56px] font-space font-bold text-text-primary leading-[1.1] max-w-4xl mx-auto">
            ...
            {visionMission.mission.content.principles.map((principle, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="text-xl font-space font-bold text-text-primary mb-4">{principle.title}</h4>
        ...
        {/* ==========================================
           ...
           ========================================== */}
        <motion.div 
          className="max-w-6xl mx-auto mt-20 md:mt-32 grid lg:grid-cols-2 gap-16 lg:gap-24 border-t border-border pt-16 md:pt-24"
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-10">
            {visionMission.microMetrics.map((metric, i) => (
              <div key={i}>
                <div className="text-4xl font-space font-bold text-text-primary mb-2">{metric.value}</div>
