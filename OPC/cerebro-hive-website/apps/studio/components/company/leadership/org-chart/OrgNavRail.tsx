...
export const OrgNavRail = () => {
  ...
  return (
    <div className="absolute top-0 left-0 bottom-0 w-16 bg-[#030608] border-r border-border flex flex-col items-center py-6 z-40">
      ...
      {/* Monogram */}
      <div className="w-10 h-10 rounded-xl bg-surface border border-border flex items-center justify-center text-text-primary font-space font-bold text-sm mb-8 shadow-inner cursor-pointer" onClick={() => { analytics.track({ eventName: 'click', category: 'org-chart', label: 'Monogram - CEO' }); handleNavClick('ceo'); }}>
        CH
      </div>
