    ...
    <Section size="default" className="border-b border-border bg-background">
      <PageContainer>
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <TrackedButton eventCategory="home-research" eventLabel="Visit Research Institute" className="px-6 py-3 border border-border rounded-lg text-sm font-bold uppercase tracking-widest text-text-primary hover:bg-surface transition-colors whitespace-nowrap">
