...
const ROLE_GRANTS: Record<string, string[]> = {
  ...
  operator: [
    ...
    "mesh:*", "eval:*", "observatory:read", "hub:read", "simulator:*", "connect:invoke", "sphere:read", "ai:*",
  ...
  developer: [
    ...
    "eval:*", "observatory:read", "simulator:*", "sphere:read", "ai:*", "flow:read", "flow:run", "mesh:read", "mesh:write",
  ...
  analyst: [
    "knowledge:read", "hub:read", "observatory:read", "sphere:read", "memory:read", "eval:read", "governance:read", "web3:read", "mesh:read",
