...
export function EnterpriseJourney() {
  ...
  return (
    <section ref={containerRef} className="py-32 relative bg-black text-white">
                  ...
                  <div className={`w-full pl-16 md:pl-0 md:w-1/2 ${isEven ? "md:pr-16" : "md:pl-16"}`}>
                    ...
                    >
                      ...
                      <div className="space-y-4">
                        <div>
                          <h4 className="text-sm font-semibold text-gray-500 mb-2 uppercase tracking-wider">Deliverables</h4>
                        ...
                        <div>
                          <h4 className="text-sm font-semibold text-gray-500 mb-1 uppercase tracking-wider">Business Outcome</h4>
