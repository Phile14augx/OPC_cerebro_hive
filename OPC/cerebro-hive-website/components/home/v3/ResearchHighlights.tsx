    ...
    <section className="py-24 border-b border-border bg-background">
      <div className="container-wide">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <button className="px-6 py-3 border border-border rounded-lg text-sm font-bold uppercase tracking-widest text-text-primary hover:bg-white/5 transition-colors whitespace-nowrap">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {research.map((item, i) => (
            <div key={i} className="flex flex-col relative group">
              ...
              {/* The Research */}
              <div className="bg-surface border border-border rounded-2xl p-8 relative z-10 hover:border-white/30 transition-colors">
