            ...
            <React.Fragment key={i}>
              <div className="bg-surface border border-border rounded-2xl p-6 md:p-8 flex flex-col md:flex-row gap-6 items-center hover:border-white/30 transition-colors">
                ...
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-xl font-space font-bold text-text-primary mb-2">{layer.layer}</h3>
                ...
                <div className="flex flex-col gap-2 w-full md:w-64">
                  ...
                  <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                    {layer.players.map((player, j) => (
                      <span key={j} className="px-2 py-1 rounded bg-surface-secondary border border-border text-[10px] font-bold text-text-primary">
                        {player}
                      </span>
                    ))}
                  </div>
                ...
                <div className="w-full md:w-48 p-3 rounded-lg bg-accent-primary/10 border border-[#00F57A]/20 text-center md:text-left">
                  <div className="text-[10px] uppercase tracking-widest text-accent-primary font-bold mb-1">CIO Action</div>
                  <div className="text-xs text-text-primary leading-tight">{layer.action}</div>
                </div>
