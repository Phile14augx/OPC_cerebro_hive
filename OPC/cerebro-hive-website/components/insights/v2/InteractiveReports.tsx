  ...
  return (
    <section className="py-24 border-b border-border bg-background">
      <div className="container-wide">
        ...
        <div className="mb-12">
          <h2 className="text-3xl md:text-5xl font-space font-bold text-text-primary mb-4">Interactive Reports</h2>
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            {reports.map((report, i) => (
              ...
              >
                ...
                <h3 className={cn("font-space font-bold mb-2", activeReport.title === report.title ? "text-text-primary" : "text-text-secondary")}>
                  {report.title}
                </h3>
              </div>
            ))}
              ...
              <div className="flex-1 p-8 overflow-y-auto relative bg-background">
                ...
                {activeSection === "Executive Summary" ? (
                  ...
                  <div className="h-full flex flex-col items-center justify-center text-center">
                    ...
                    <h4 className="text-text-primary font-bold mb-2">Gated Content</h4>
