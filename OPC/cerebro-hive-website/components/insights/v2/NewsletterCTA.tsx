  ...
  return (
    <section className="py-24 border-b border-white/5 bg-[#05070A] relative overflow-hidden">
      ...
      <div className="container-wide max-w-4xl relative z-10">
        ...
        <div className="bg-surface/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-16 text-center shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-3xl md:text-5xl font-space font-bold text-white mb-4">Weekly Executive Intelligence</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mb-12">
            <div className="flex items-center gap-2 text-sm text-text-muted">
              <CheckCircle2 size={16} className="text-[#00F57A]" /> Strategic analysis
            </div>
            <div className="flex items-center gap-2 text-sm text-text-muted">
              <CheckCircle2 size={16} className="text-[#00F57A]" /> Market updates
            </div>
            <div className="flex items-center gap-2 text-sm text-text-muted">
              <CheckCircle2 size={16} className="text-[#00F57A]" /> Architecture insights
            </div>
          </div>
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto" onSubmit={(e) => e.preventDefault()}>
            <input 
              ...
              className="flex-1 px-6 py-4 bg-black/50 border border-white/10 rounded-xl text-white placeholder:text-text-muted focus:outline-none focus:border-[#00E5FF]/50 transition-colors" 
              required
            />
            <button 
              type="submit" 
