    ...
    <section className="py-24 border-b border-white/5 bg-[#05070A]">
      <div className="container-wide max-w-5xl">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-space font-bold text-white mb-4">AI Strategy Canvas</h2>
        ...
        {generating && (
          <div className="bg-surface border border-white/10 rounded-2xl p-12 text-center flex flex-col items-center">
            <div className="w-16 h-16 rounded-full border-4 border-white/10 border-t-[#7B61FF] animate-spin mb-6" />
            <h3 className="text-2xl font-space font-bold text-white mb-2">Synthesizing Strategy</h3>
        ...
        <AnimatePresence>
          {generated && (
            <motion.div 
              ...
              className="bg-surface/50 border border-white/10 rounded-2xl p-6 md:p-10 relative overflow-hidden"
            >
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-10">
                <div>
                  <h3 className="text-3xl font-space font-bold text-white mb-2">Executive AI Strategy Brief</h3>
                  <div className="text-xs font-bold uppercase tracking-widest text-text-muted">Prepared for: CIO • Finance Sector</div>
                </div>
                <button className="px-6 py-3 bg-[#7B61FF] text-white font-space font-bold text-sm uppercase tracking-widest rounded-lg flex items-center gap-2 hover:opacity-90 transition-opacity whitespace-nowrap">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="bg-black/50 border border-white/5 rounded-xl p-6">
                  <div className="text-[10px] uppercase tracking-widest text-[#00E5FF] font-bold mb-4 flex items-center gap-2">
                ...
                <div className="bg-black/50 border border-white/5 rounded-xl p-6">
                  <div className="text-[10px] uppercase tracking-widest text-[#00F57A] font-bold mb-4 flex items-center gap-2">
                    <DollarSign size={14} /> Estimated ROI
                  </div>
                  <div className="text-4xl font-space font-bold text-white mb-2">2.4x</div>
              ...
              <div className="space-y-6">
                <h4 className="font-space font-bold text-white text-lg border-b border-white/10 pb-2">Implementation Phases</h4>
                
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-1 bg-white/5 border border-white/10 p-5 rounded-xl">
                    <div className="text-[10px] uppercase tracking-widest text-text-muted font-bold mb-2">Phase 1: 0-3 Months</div>
                    <div className="font-bold text-white mb-2 flex items-center gap-2"><Layers size={14} className="text-[#00E5FF]" /> Knowledge Hub</div>
                    <p className="text-xs text-text-secondary">Deploy vector infrastructure and ground models in enterprise data.</p>
                  </div>
                  <div className="flex-1 bg-white/5 border border-white/10 p-5 rounded-xl border-[#7B61FF]/30">
                    <div className="text-[10px] uppercase tracking-widest text-[#7B61FF] font-bold mb-2">Phase 2: 3-9 Months</div>
                    <div className="font-bold text-white mb-2 flex items-center gap-2"><Bot size={14} className="text-[#7B61FF]" /> Agent Pilot</div>
                  ...
                  <div className="flex-1 bg-white/5 border border-white/10 p-5 rounded-xl">
                    ...
                    <div className="font-bold text-white mb-2 flex items-center gap-2"><Network size={14} className="text-[#00F57A]" /> Swarm Scaling</div>
