  ...
  return (
    <section className="py-24 border-b border-white/5 bg-[#0A0D14]">
      <div className="container-wide">
        ...
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-surface to-black border border-white/10 rounded-2xl overflow-hidden shadow-2xl relative">
          ...
          <div className="p-8 md:p-12 border-b border-white/10 relative z-10">
            <div className="flex items-center gap-4 mb-6">
              <span className="px-3 py-1 bg-[#00E5FF]/10 text-[#00E5FF] border border-[#00E5FF]/30 rounded text-[10px] uppercase tracking-widest font-bold">
                Weekly Briefing
              </span>
          ...
          <div className="p-8 md:p-12 grid md:grid-cols-3 gap-8 relative z-10">
            ...
            <div className="space-y-4">
              <div className="text-[10px] uppercase tracking-widest text-text-muted font-bold flex items-center gap-2 mb-2">
                <AlertTriangle size={14} className="text-[#FFB300]" /> Major Developments
              </div>
              <ul className="space-y-3">
                <li className="text-sm text-text-secondary pb-3 border-b border-white/5 leading-relaxed">
                  <span className="text-white font-bold block mb-1">OpenAI introduces structured outputs for agents.</span>
                  Ensures deterministic JSON responses, critical for ERP integration.
                </li>
                <li className="text-sm text-text-secondary pb-3 border-b border-white/5 leading-relaxed">
                  <span className="text-white font-bold block mb-1">EU AI Act enforcement timeline clarified.</span>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg bg-black/40 border border-white/5">
                <div className="text-xs text-white font-bold mb-1">Why it matters</div>
            ...
            <div className="space-y-4">
              <div className="text-[10px] uppercase tracking-widest text-text-muted font-bold flex items-center gap-2 mb-2">
                <Target size={14} className="text-[#00E5FF]" /> Recommended Actions
              </div>
              <ul className="space-y-3 mb-6">
                <li className="text-sm text-text-secondary flex gap-3">
                  <div className="w-5 h-5 rounded bg-[#00E5FF]/10 text-[#00E5FF] flex items-center justify-center font-bold text-xs shrink-0">1</div>
                ...
                <li className="text-sm text-text-secondary flex gap-3">
                  <div className="w-5 h-5 rounded bg-[#00E5FF]/10 text-[#00E5FF] flex items-center justify-center font-bold text-xs shrink-0">2</div>
              ...
              <button className="w-full py-3 bg-[#00E5FF]/10 text-[#00E5FF] border border-[#00E5FF]/30 rounded-lg text-xs font-bold uppercase tracking-widest hover:bg-[#00E5FF] hover:text-black transition-colors flex items-center justify-center gap-2">
