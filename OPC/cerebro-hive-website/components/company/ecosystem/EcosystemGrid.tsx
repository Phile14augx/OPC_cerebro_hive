        ...
        <div className="flex flex-wrap justify-center gap-4">
          {partners.technology.map((tech, index) => (
            <motion.div
              ...
              className="px-6 py-3 rounded-full bg-surface-elevated border border-border flex items-center gap-2 hover:border-primary-accent/50 transition-colors"
            >
          ...
          {partners.research.map((tech, index) => (
            <motion.div
              ...
              className="px-6 py-3 rounded-full bg-surface-elevated border border-border flex items-center gap-2 hover:border-[#00E5FF]/50 transition-colors"
            >
