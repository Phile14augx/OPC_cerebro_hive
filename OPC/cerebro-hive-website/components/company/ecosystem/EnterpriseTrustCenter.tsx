  ...
  return (
    <section id="trust-center" className="section-pad bg-background relative overflow-hidden border-t border-border">
      ...
      <div className="container-wide relative z-10">
        ...
        <div className="mt-32 pt-16 border-t border-white/5 flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12">
          
          <div className="flex flex-wrap justify-center lg:justify-start gap-x-3 gap-y-4 w-full lg:w-auto lg:max-w-2xl">
          ...
          <div className="flex flex-wrap justify-center lg:justify-end gap-6 lg:gap-8 w-full lg:w-auto">
            <a href="#" className="flex items-center gap-2 text-sm font-space font-bold text-text-secondary hover:text-white transition-colors group whitespace-nowrap">
