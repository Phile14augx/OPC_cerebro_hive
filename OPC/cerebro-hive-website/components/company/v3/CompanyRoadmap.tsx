    ...
    <section className="py-24 border-b border-white/5 bg-[#0A0D14]">
      <div className="container-wide">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-space font-bold text-white mb-6">Strategic Vision</h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row gap-4 items-stretch">
            ...
            <div className="flex-1 p-8 rounded-2xl bg-surface border border-white/10 relative overflow-hidden group">
              <div className="text-xs font-bold uppercase tracking-widest text-text-muted mb-6">Today</div>
              <h3 className="text-2xl font-space font-bold text-white mb-4 group-hover:text-[#00E5FF] transition-colors">Enterprise Platform</h3>
            ...
            <div className="flex-1 p-8 rounded-2xl bg-surface border border-white/10 relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-space font-bold text-white mb-4 group-hover:text-[#00F57A] transition-colors">AI Operating System</h3>
              <p className="text-sm text-text-secondary">
            ...
            <div className="flex-1 p-8 rounded-2xl bg-surface border border-[#7B61FF]/30 relative overflow-hidden group shadow-[0_0_30px_rgba(123,97,255,0.05)]">
              ...
              <h3 className="text-2xl font-space font-bold text-white mb-4 relative z-10">The Autonomous Enterprise</h3>
