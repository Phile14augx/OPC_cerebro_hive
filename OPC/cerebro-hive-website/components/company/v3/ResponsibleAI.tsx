      ...
      <div className="container-wide">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="flex-1">
            <h2 className="text-3xl md:text-5xl font-space font-bold text-white mb-6">Trust is not a feature. It is the foundation.</h2>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between p-4 border border-white/10 rounded-xl bg-surface">
                <span className="font-bold text-white text-sm">EU AI Act Compliant Architecture</span>
                <span className="text-[10px] uppercase tracking-widest text-[#00F57A] font-bold px-2 py-1 bg-[#00F57A]/10 rounded-full">Standard</span>
              </div>
              <div className="flex items-center justify-between p-4 border border-white/10 rounded-xl bg-surface">
                <span className="font-bold text-white text-sm">SOC2 Type II & HIPAA</span>
                <span className="text-[10px] uppercase tracking-widest text-[#00F57A] font-bold px-2 py-1 bg-[#00F57A]/10 rounded-full">Standard</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 w-full grid sm:grid-cols-2 gap-4">
            ...
            <div className="p-6 bg-surface border border-white/10 rounded-2xl relative overflow-hidden">
              <div className="absolute top-0 right-0 p-4 text-white/5"><Eye size={64} /></div>
              <Eye size={20} className="text-[#00E5FF] mb-4 relative z-10" />
              <h3 className="font-space font-bold text-white mb-2 relative z-10">Human Oversight</h3>
            ...
            <div className="p-6 bg-surface border border-white/10 rounded-2xl relative overflow-hidden">
              ...
              <Lock size={20} className="text-[#FFB300] mb-4 relative z-10" />
              <h3 className="font-space font-bold text-white mb-2 relative z-10">Data Privacy</h3>
            ...
            <div className="p-6 bg-surface border border-white/10 rounded-2xl relative overflow-hidden">
              ...
              <h3 className="font-space font-bold text-white mb-2 relative z-10">Security</h3>
            ...
            <div className="p-6 bg-surface border border-white/10 rounded-2xl relative overflow-hidden">
              ...
              <h3 className="font-space font-bold text-white mb-2 relative z-10">Transparency</h3>
