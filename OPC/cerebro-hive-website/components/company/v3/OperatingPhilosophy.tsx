    ...
    <section className="py-24 border-b border-white/5 bg-[#0A0D14]">
      <div className="container-wide">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] uppercase tracking-widest text-[#FFB300] font-bold mb-6">
            <Scale size={12} /> Operating Philosophy
          </div>
          <h2 className="text-3xl md:text-5xl font-space font-bold text-white mb-6">The principles that guide every decision we make.</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              {philosophies.map((p, i) => (
                <div key={i} className="flex items-center justify-between p-6 rounded-2xl bg-surface border border-white/10 group hover:border-[#FFB300]/50 transition-colors">
                  <div className="text-xl font-space font-bold text-white group-hover:text-[#FFB300] transition-colors">{p.left}</div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-6 h-full">
              {absolutes.map((abs, i) => (
                <div key={i} className="flex-1 p-8 rounded-2xl bg-black/50 border border-white/5 relative overflow-hidden flex items-center gap-6 group hover:bg-white/5 transition-colors">
                  ...
                  <div className="text-xl font-space font-bold text-white leading-tight">
                    {abs}
                  </div>
                </div>
              ))}
