    ...
    <section className="py-24 border-b border-white/5 bg-[#05070A]">
      <div className="container-wide">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-space font-bold text-white mb-6">Global Operating Model</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="p-8 rounded-2xl bg-surface border border-white/10">
            <MapPin size={24} className="text-[#00E5FF] mb-6" />
            <h3 className="text-xl font-space font-bold text-white mb-2">Headquarters</h3>
          ...
          <div className="p-8 rounded-2xl bg-surface border border-white/10">
            <Code size={24} className="text-[#00F57A] mb-6" />
            <h3 className="text-xl font-space font-bold text-white mb-2">Platform Engineering</h3>
          ...
          <div className="p-8 rounded-2xl bg-surface border border-white/10">
            ...
            <h3 className="text-xl font-space font-bold text-white mb-2">AI Research</h3>
