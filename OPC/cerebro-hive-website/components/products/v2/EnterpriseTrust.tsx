    ...
    <section className="py-24 border-b border-border bg-surface relative overflow-hidden">
      ...
      <div className="container-wide relative z-10">
        ...
        <div className="text-center mb-16">
          <span className="text-[10px] font-bold uppercase tracking-widest text-[#00F57A] mb-3 block flex justify-center items-center gap-2">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {/* Technical Trust */}
          <div className="bg-[#0A0D14] border border-[#00E5FF]/20 rounded-2xl p-8 relative overflow-hidden group hover:border-[#00E5FF]/50 transition-colors">
            ...
            <h3 className="text-2xl font-space font-bold text-white mb-2">Technical Trust</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {technicalTrust.map((item, i) => (
                <div key={i} className="flex items-center gap-3 p-3 bg-surface/50 border border-white/5 rounded-xl hover:bg-surface transition-colors">
                  <div className="p-1.5 rounded bg-[#00E5FF]/10 text-[#00E5FF]">
                    <item.icon size={16} />
                  </div>
          ...
          {/* Business Trust */}
          <div className="bg-[#0A0D14] border border-[#00F57A]/20 rounded-2xl p-8 relative overflow-hidden group hover:border-[#00F57A]/50 transition-colors">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#00F57A]/10 rounded-bl-full pointer-events-none transition-transform group-hover:scale-110" />
            
            <h3 className="text-2xl font-space font-bold text-white mb-2">Business Trust</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {businessTrust.map((item, i) => (
                <div key={i} className="flex items-center gap-3 p-3 bg-surface/50 border border-white/5 rounded-xl hover:bg-surface transition-colors">
                  <div className="p-1.5 rounded bg-[#00F57A]/10 text-[#00F57A]">
                    <item.icon size={16} />
                  </div>
                  <span className="text-sm font-medium text-white">{item.label}</span>
                </div>
        ...
        <div className="mt-16 text-center border-t border-border pt-16 max-w-4xl mx-auto">
          <h3 className="text-xl font-space font-bold text-white mb-8">Deploy Wherever Your Data Lives</h3>
          <div className="flex flex-wrap justify-center gap-4">
            {["AWS", "Google Cloud", "Microsoft Azure", "Private Cloud", "On-Premise Air-Gapped"].map((env, i) => (
              <span key={i} className="px-5 py-2.5 bg-surface-elevated border border-white/10 rounded-full text-sm font-bold text-white shadow-sm flex items-center gap-2">
