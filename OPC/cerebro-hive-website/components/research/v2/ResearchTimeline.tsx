        ...
        <div className="max-w-5xl mx-auto overflow-x-auto no-scrollbar pb-8">
          <div className="min-w-[800px]">
            ...
            <div className="flex items-end mb-8 relative">
              <div className="w-32 shrink-0 text-right pr-6 text-[10px] uppercase tracking-widest text-accent-secondary font-bold">Research</div>
              {timeline.map((item, i) => (
                <div key={i} className="flex-1 flex flex-col items-center px-4 relative z-10 group cursor-pointer">
                  <div className="bg-surface border border-border rounded-lg p-4 w-full text-center hover:border-[#00E5FF]/50 transition-colors">
            ...
            <div className="flex items-start mt-8 relative">
              <div className="w-32 shrink-0 text-right pr-6 text-[10px] uppercase tracking-widest text-accent-primary font-bold">Products</div>
              {timeline.map((item, i) => (
                <div key={i} className="flex-1 flex flex-col items-center px-4 relative z-10 group cursor-pointer">
