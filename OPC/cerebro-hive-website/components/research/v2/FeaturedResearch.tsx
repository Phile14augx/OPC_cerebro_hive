    ...
    <section className="py-24 border-b border-white/5 bg-[#05070A]">
      <div className="container-wide">
        ...
        <div className="flex items-center justify-between mb-10">
          <h2 className="text-2xl md:text-3xl font-space font-bold text-white">Editorial Curation</h2>
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 group cursor-pointer">
            <div className="bg-surface border border-white/10 rounded-2xl p-8 md:p-12 h-full flex flex-col justify-end relative overflow-hidden transition-all hover:border-primary-accent/50">
              ...
              <div className="relative z-20">
                ...
                <h3 className="text-3xl md:text-5xl font-space font-bold text-white mb-4 leading-tight group-hover:text-primary-accent transition-colors">
                  {featured.title}
                </h3>
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            <div className="bg-black/40 border border-white/5 rounded-2xl p-6 mb-2">
              <div className="text-xs uppercase tracking-widest text-[#00E5FF] font-bold mb-1 flex items-center gap-2">
                <Bookmark size={14} /> Trending Now
              </div>
            </div>
            
            {trending.map((item, i) => (
              <div key={i} className="bg-surface border border-white/5 rounded-xl p-6 group cursor-pointer hover:bg-white/5 transition-colors flex flex-col justify-between h-full">
                <div>
                  <div className="text-[10px] text-text-muted uppercase tracking-widest font-bold mb-3">{item.category}</div>
                  <h4 className="text-lg font-space font-bold text-white mb-2 leading-snug group-hover:text-[#00E5FF] transition-colors">{item.title}</h4>
                </div>
