...
const AcademicNode = ({ data }: NodeProps) => {
  return (
    <div className="px-4 py-2 bg-white border border-gray-300 shadow-sm rounded-sm flex flex-col items-center justify-center min-w-[120px]">
  ...
  return (
    <div className="w-full h-[600px] bg-[#f8fafc] border border-gray-200 rounded-sm relative overflow-hidden flex flex-col">
      ...
      >
        ...
        <Panel position="top-left" className="bg-white/90 backdrop-blur-sm border border-gray-200 p-3 rounded-sm shadow-sm max-w-xs">
           <div className="flex flex-col gap-1">
             <span className="text-[10px] font-bold uppercase tracking-widest text-gray-500">{data.figureNumber}</span>
        ...
        <Panel position="bottom-right" className="flex gap-2">
           <button className="p-2 bg-white border border-gray-200 rounded-sm shadow-sm text-gray-600 hover:text-black transition-colors" title="Download SVG">
             <Download size={14} />
           </button>
           <button className="p-2 bg-white border border-gray-200 rounded-sm shadow-sm text-gray-600 hover:text-black transition-colors" title="Export JSON">
             <FileJson size={14} />
           </button>
           <button className="p-2 bg-white border border-gray-200 rounded-sm shadow-sm text-gray-600 hover:text-black transition-colors" title="Fullscreen">
             <Maximize size={14} />
           </button>
        </Panel>
