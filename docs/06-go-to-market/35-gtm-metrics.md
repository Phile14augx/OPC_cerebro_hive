...
KPIs for marketing and sales: MQLs, SQLs, CAC, LTV, and pipeline velocity.
...
| --- | --- | --- | --- |
| GTM Metrics Dashboard primary KPI | [Target] | [Method] | Monthly |
| GTM Metrics Dashboard secondary KPI | [Target] | [Method] | Quarterly |
