...
| CerebroLearn™ | `products/ai-productivity/cerebrolearn.md` | Beta |
| CerebroAssist™ | `products/ai-productivity/cerebroassist.md` | MVP |

## Enterprise Business Applications (10 products)
| Product | Spec File | Lifecycle |
|---|---|---|
| CerebroERP™ | `products/business-applications/cerebroerp.md` | MVP |
| CerebroCRM™ | `products/business-applications/cerebrocrm.md` | MVP |
| CerebroHR™ | `products/business-applications/cerebrohr.md` | MVP |
| CerebroFinance™ | `products/business-applications/cerebrofinance.md` | MVP |
| CerebroProcurement™ | `products/business-applications/cerebroprocurement.md` | MVP |
| CerebroProjects™ | `products/business-applications/cerebroprojects.md` | MVP |
| CerebroAssets™ | `products/business-applications/cerebroassets.md` | MVP |
| CerebroQuality™ | `products/business-applications/cerebroquality.md` | MVP |
| CerebroCompliance™ | `products/business-applications/cerebrocompliance.md` | MVP |
| CerebroCustomer360™ | `products/business-applications/cerebrocustomer360.md` | MVP |
...
## AI Runtime & Platform (7 products)
| Product | Spec File | Lifecycle |
|---|---|---|
| HiveModels™ | `products/runtime/hivemodels.md` | Beta |
| HiveAgents™ | `products/runtime/hiveagents.md` | Beta |
...
| Product | Spec File | Lifecycle |
|---|---|---|
| HiveExchange™ | `products/ecosystem/hiveexchange.md` | Research |
| HiveMarketplace™ | `products/ecosystem/hivemarketplace.md` | Research |
| HiveBilling™ | `products/ecosystem/hivebilling.md` | Beta |
| HiveLicense™ | `products/ecosystem/hivelicense.md` | Beta |
| HivePartner™ | `products/ecosystem/hivepartner.md` | MVP |
| HiveDeploy™ | `products/ecosystem/hivedeploy.md` | Beta |
| HiveCloud™ | `products/ecosystem/hivecloud.md` | GA |
| HiveGovern™ | `products/ecosystem/hivegovern.md` | Beta |
