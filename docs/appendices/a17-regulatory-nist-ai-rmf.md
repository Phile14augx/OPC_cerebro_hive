---
title: "Appendix H2 -- NIST AI RMF Reference Guide"
part: "Appendices"
...
# Appendix H2 -- NIST AI RMF Reference Guide

> **Note:** Reference document -- kept current by the CerebroHive Operations team. Last reviewed: [DATE]

## Overview

Practical reference for NIST AI Risk Management Framework: Govern, Map, Measure, Manage functions.
