---
title: "TDR -- Agent Framework Selection"
part: "Part X"
...
# TDR -- Agent Framework Selection

## Purpose

Technology Decision Record: LangGraph vs. CrewAI vs. AutoGen vs. custom implementation.
...
# Replace with actual implementation patterns for: TDR -- Agent Framework Selection
```
