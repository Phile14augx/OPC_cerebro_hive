---
title: "TDR -- Cloud Provider Selection"
part: "Part X"
...
# TDR -- Cloud Provider Selection

## Purpose

Technology Decision Record: AWS vs. Azure vs. GCP for enterprise AI workloads.
...
# Replace with actual implementation patterns for: TDR -- Cloud Provider Selection
```
