...
CerebroHive targets mid-market to enterprise organizations that are actively investing in AI and digital transformation but lack the internal capability to design and execute at the pace the market demands.

## Total Addressable Market

The global AI consulting and services market is estimated at $150–200B by 2028, growing at 35% CAGR. CerebroHive's serviceable market -- English-speaking enterprises in North America, UK, Australia, and Middle East -- represents approximately $40–60B of this total.
...
| Geography | North America (primary), UK, Australia, UAE/KSA (secondary) |
| Technology maturity | Cloud-first or cloud-transitioning |
| AI maturity | HiveScore Level 1–3 (exploring to scaling) |
| Budget | Has approved AI transformation budget ≥$500K/year |
| Buying trigger | Board mandate, competitive pressure, regulatory deadline, M&A, legacy failure |
| Decision maker | CTO, CDO, COO, or CEO with AI as a stated priority |

## Negative ICP -- Who We Do NOT Pursue

- Staff augmentation only -- no strategic engagement
- No data infrastructure and unwilling to invest
- Decision cycles >3 years with no identifiable executive sponsor
- Pure cost-cutting mandates, no AI vision or capability-building intent
- Highly regulated sectors (e.g., nuclear, defense) without dedicated compliance infrastructure
